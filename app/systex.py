...
class SearchSystex:
	def __init__(driver):
			...
			#TestOddLet.oddLet(driver,testName,OddLot.compareOddLotName(driver,companyName),"","")
			Leave.leave(driver)
