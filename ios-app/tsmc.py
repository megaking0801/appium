...
class SearchTsmc:
	def __init__(driver):
            ...
            tsmc = driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="台積電 2330")
            ...
            try:
                ...
                ws['B27'] = my_list[40]+my_list[35]
                ws['C27'] = my_list[46]+my_list[41]
                ws['D27'] = my_list[36]+my_list[37]
                ws['E27'] = datetime.now()
                ws['E27'].number_format = 'yyyy-mm-dd hh:mm:ss'
                ws['B28'] = my_list[42]+my_list[43]
                ws['C28'] = my_list[38]+my_list[39]
                ws['D28'] = my_list[44]+my_list[45]
                ws['E28'] = datetime.now()
                ws['E28'].number_format = 'yyyy-mm-dd hh:mm:ss'
                ws['B29'] = my_list[31]+my_list[27]
                ws['C29'] = my_list[32]+my_list[28]
                ws['E29'] = datetime.now()
                ws['E29'].number_format = 'yyyy-mm-dd hh:mm:ss'
		...
		#外資
            ...
            if(a != "日期"):
                ...
                ws['C30'] = "wrong"
                ws['E30'] = datetime.now()
                ws['E30'].number_format = 'yyyy-mm-dd hh:mm:ss'
            else:
    ...
    #投信
            ...
            if(a != "日期"):
                ...
                ws['C31'] = "wrong"
                ws['E31'] = datetime.now()
                ws['E31'].number_format = 'yyyy-mm-dd hh:mm:ss'
            else:
    ...
    #自營
            ...
            if(a != "日期"):
                ...
                ws['C32'] = "wrong"
                ws['E32'] = datetime.now()
                ws['E32'].number_format = 'yyyy-mm-dd hh:mm:ss'
            else:
    ...
    #融資
            ...
            if(a != "日期"):
                ...
                ws['C33'] = "wrong"
                ws['E33'] = datetime.now()
                ws['E33'].number_format = 'yyyy-mm-dd hh:mm:ss'
            else:
    ...
    #融券
            ...
            if(a != "日期"):
                ...
                ws['C34'] = "wrong"
                ws['E34'] = datetime.now()
                ws['E34'].number_format = 'yyyy-mm-dd hh:mm:ss'
            else:
                b = table.cell(0,1).paragraphs[0].add_run("測試結果：融資日期標題無誤" )
                b.font.name='黑體'
                b.font.size=Pt(16)
            ...
            try:
                ...
                if(companyName!="台積電 2330"):
                    b = table.cell(0,1).paragraphs[0].add_run("測試結果：自選頁面名稱錯誤" )
                    b.font.name='黑體'
                    b.font.size=Pt(16)
                    ws['C8'] = "wrong"
                    ws['E8'] = datetime.now()
                    ws['E8'].number_format = 'yyyy-mm-dd hh:mm:ss'
                    print("自選頁面名稱錯誤")
                else:
            ...
            try:
                ...
                oddLot = driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="台積電 2330")
                ...
                a.font.size=Pt(16)
                ws['B9'] = '確認零股名稱是否正確'
                if(oddLotName!="台積電 2330"):
                    b = table.cell(0,1).paragraphs[0].add_run("測試結果：零股名稱錯誤" )
                    b.font.name='黑體'
                    b.font.size=Pt(16)
                    ws['C9'] = "wrong"
                    ws['E9'] = datetime.now()
                    ws['E9'].number_format = 'yyyy-mm-dd hh:mm:ss'
                    print("零股名稱錯誤")
                else:
            ...
            try:
                ...
                a = table.cell(0,1).paragraphs[0].add_run("測試結果：沒有說明書")
                a.font.name='黑體'
                a.font.size=Pt(16)
                ws['C10'] = 'No'
                ws['E10'] = datetime.now()
                ws['E10'].number_format = 'yyyy-mm-dd hh:mm:ss'
                doc.add_page_break()
                doc.save('test.docx')    
		...
		#KLine Name
            try:
                doc = Document('test.docx')
                KLineName = driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="2330 台積電")
                ...
                if(KLineName!="2330 台積電"):
                    b = table.cell(0,1).paragraphs[0].add_run("測試結果:K線名稱錯誤" )
                    b.font.name='黑體'
                    b.font.size=Pt(16)
                    ws['C11'] = 'wrong'
                    ws['E11'] = datetime.now()
                    ws['E11'].number_format = 'yyyy-mm-dd hh:mm:ss'
                    print("K線名稱錯誤")
                else:
            ...
            try:
                ...
                el5 = driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="台積電")
                Name = el5.text
                ...
                if(Name != "台積電"):
                    ...
                    ws['C12'] = 'wrong'
                    ws['E12'] = datetime.now()
                    ws['E12'].number_format = 'yyyy-mm-dd hh:mm:ss'
                else:
            ...
            try:
                ...
                if(Name != "台積電"):
                    ...
                    ws['C13'] = 'wrong'
                    ws['E13'] = datetime.now()
                    ws['E13'].number_format = 'yyyy-mm-dd hh:mm:ss'
                else:
